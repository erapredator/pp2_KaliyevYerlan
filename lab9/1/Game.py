...
path = r'C:\erapp\pp2_KaliyevYerlan\lab9\1\\'
...
background_music = pygame.mixer.music.load(r'C:\erapp\pp2_KaliyevYerlan\lab9\1\background.wav')
    ...
    while running:
        ...
        while i < len(coins):
            ...
            if player.rect.colliderect(coins[i]):
                pygame.mixer.Sound(r'C:\erapp\pp2_KaliyevYerlan\lab9\1\coinsound.mp3').play()
